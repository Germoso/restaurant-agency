                    ...
                    <div className="container mx-auto flex flex-col lg:flex-row lg:gap-5 items-center h-full">
                        ...
                        >
                            ...
                            <p className="opacity-75 pt-4 text-lg">
                                Te ofrecemos la solución más fácil y asequible para tener una presencia en línea
                                exitosa. Creamos y administramos tu sitio web gratis, para que puedas concentrarte en lo
                                que realmente importa: <b>tu negocio de comida.</b>
                            </p>
                        </motion.div>
                        <motion.div
                            viewport={{ once: false }}
